...
#include "D2JPlayerMovementComponent.generated.h"
...
class D2JAM_2_API UD2JPlayerMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()

public:
	UD2JPlayerMovementComponent();
